...
function FbButton() {
  ...
  useEffect(() => {
    ...
    const shareHtml = `<iframe src="https://www.facebook.com/plugins/share_button.php?href=${dynamicUrl}&layout=button&size=large&width=100&height=30&appId=" width="10" height="30" style="border:none;overflow:hidden;" scrolling="no" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>`;
